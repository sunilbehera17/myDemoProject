...
public final class FrameworkConstants {
    ...
    public static final String EXCEL_TESTDATA_MPV = PropertiesHelpers.getValue("EXCEL_TESTDATA_MPV");
    public static final String EXCEL_TESTDATA_PV = PropertiesHelpers.getValue("EXCEL_TESTDATA_PV");
    ...
    public static final String URL_PV = PropertiesHelpers.getValue("URL_PV");
    ...
    public static final String ICON_SOCIAL_GITHUB_PAGE_URL = "https://";
    public static final String ICON_SOCIAL_LINKEDIN_URL = "https://";
    public static final String ICON_SOCIAL_GITHUB_URL = "https://";
